...
<p align="center">
  <b>Full Stack Software Developer | CEO & President @ CodeFlakes ICT (2019–Jul 2026)</b>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/HUB-ROOT">
    <img src="https://img.shields.io/github/followers/HUB-ROOT?label=Followers&style=social" alt="GitHub Followers" />
  </a>
</p>
...
<table>
  ...
  <tr>
    <td><b>🚀 Leading</b></td>
    <td>CEO & President @ CodeFlakes ICT (2019 – Jul 2026)</td>
  </tr>
</table>
...
- 📱 **Cross-platform mobile apps** — Built with Flutter & SQLite/SQFlite
- 🌐 **Web platforms** — Powered by Laravel, .NET, PostgreSQL & MariaDB
- 🔧 **System architecture** — Clean Architecture, EFCore, scalable solutions
- 📊 **Reporting solutions** — JasperReports, JasperServer, Crystal Reports, RDLC
...
|----------|--------------|
| **Backend** | C# .NET, PHP Laravel, REST APIs, GraphQL |
| **Frontend** | JavaScript, HTML5, CSS3, Responsive Design |
| **Mobile** | Flutter, Dart, SQFlite, Firebase |
| **Databases** | SQL Server, PostgreSQL, SQLite, MariaDB, MongoDB |
